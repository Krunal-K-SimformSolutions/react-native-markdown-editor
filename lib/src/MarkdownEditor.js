      ...
      <WrapperView behavior="padding" style={styles.screen}>
        ...
        {!onlyPreview && <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            style={{ padding: 8, borderRightWidth: 1, borderColor: foregroundColor }}>
            <Image
              style={[styles.button, { tintColor: foregroundColor, padding: 8 }]}
              source={showPreview ? require('../static/edit.png') : require('../static/visibility.png')}
              resizeMode={'cover'}
            />
          </TouchableOpacity>
          <View style={{flex: 1, justifyContent: 'center', marginTop: showPreview ? 4 : 2}}>
            {renderFormatButtons(
              {
